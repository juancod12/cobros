...
import { ventasModuleDetails } from '@/data/ventas-modules';

export default function VentasModuleDetailScreen() {
  const params = useLocalSearchParams<{ slug?: string }>();
  const slug = typeof params.slug === 'string' ? params.slug : '';
  const moduleData = ventasModuleDetails[slug as keyof typeof ventasModuleDetails];
