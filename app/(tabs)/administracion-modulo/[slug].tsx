...
import { administracionModuleDetails } from '@/data/administracion-modules';

export default function AdministracionModuleDetailScreen() {
  const params = useLocalSearchParams<{ slug?: string }>();
  const slug = typeof params.slug === 'string' ? params.slug : '';
  const moduleData = administracionModuleDetails[slug as keyof typeof administracionModuleDetails];
