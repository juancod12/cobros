...
import { generalModuleDetails } from '@/data/general-modules';

export default function GeneralModuleDetailScreen() {
  const params = useLocalSearchParams<{ slug?: string }>();
  const slug = typeof params.slug === 'string' ? params.slug : '';
  const moduleData = generalModuleDetails[slug as keyof typeof generalModuleDetails];
